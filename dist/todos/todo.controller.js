...
const create_todo_dto_1 = require("./datatransferobject/create-todo.dto");
const change_todo_dts_1 = require("./datatransferobject/change-todo.dts");
...
__decorate([
    ...
    (0, common_1.Header)('Content-Type', 'applicaton/json'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [change_todo_dts_1.ChangeTodo, String]),
    __metadata("design:returntype", void 0)
